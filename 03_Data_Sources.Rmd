...
2.  Listen to the NPR Planet Money #222 
    ...
    b) In the podcast, how many people were tasked with collecting the raw data?
    c) In the podcast, how many items are priced each month to create the CPI?
    d) There are two variants of CPI, what are they?
