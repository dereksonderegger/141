...
students %>%
  group_by(Grade) %>%
  summarize(Number = n(), Avg_Height = mean(Height)) %>%
  pander::pander()
```
...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=yb2zkxHDfUE" frameborder="0" allowfullscreen></iframe>
...
<iframe width="560" height="315" src="https://www.youtube.com/watch?v=DsZ7lsTaAYo" frameborder="0" allowfullscreen></iframe>
