...
2.  Start with the strongest relationship with those variables on the x and y axis. 
    ...
    on the grouping scale (facets, shape).

The critical aspect is that I want to select the most important relationship to 
be displayed via the x and y axis and then other relationships added on top via 
the other graph attributes.
