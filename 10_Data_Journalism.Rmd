...
2.  Make sure each figure has a title that describes what the reader what 
...
2.  Produce an article/essay that has a target audience of your fellow classmates.
    ...
    a)  Introduces your sufficient background information to understand why your 
        question is interesting.
    b)  Shows both a general trend and and addresses how the trend changes (if 
        at all) across sub-groups.
    c)  Gives sufficient detail into how the data was collected and prepared that
        the audience trusts the data source and could conceivable recreate the analysis.
        You could do a formal "literature cited" section, or you could have a
        section that clearly links to the necessary information.
    d)  The article should have *at least* three different graphics prepared by
        you.
    e)  The article clearly explains the background and reasoning as a narrative
        explanation in conjunction with the graphics.
